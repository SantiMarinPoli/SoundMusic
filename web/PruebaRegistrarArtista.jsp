        ...
        <div class="container main-container">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="controladorArtista" name="formulario_artista" method="post">                        
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="pais" name="pais" >
                                <%
                                    List<Pais> lstPais = (List<Pais>) request.getAttribute("lstPais");
                                    for (Pais pa : lstPais) {
                                        out.print("<option value='" + pa.getIdPais()
                                                + "'>" + pa.getNombre() + "</option>");
                                    }
                                %>                                
                            </select>
                            ...
                            <select class="form-control" id="ciudad" name="ciudad" >
                                <%
                                    List<Ciudad> lstCiudad = (List<Ciudad>) request.getAttribute("lstCiudad");
                        ...
                        <div class="form-group">
                            <label>Celular*</label>
                            <input type="number" class="form-control" name="celular" id="celular" placeholder="Ingresar el celular " >
                            <label>Telefono*</label>
                            <input type="number" class="form-control" name="telefono" id="telefono" placeholder="Ingresar el telefono " >
                            <label>Direccion*</label>
                            <input type="text" class="form-control" name="direccion" id="direccion" placeholder="Ingresar el direccion " >
                            <label>Barrio*</label>
                            <input type="text" class="form-control" name="barrio" id="barrio" placeholder="Ingresar el barrio " >
                            <label>Email*</label>
                            <input type="email" class="form-control" name="email" id="email" placeholder="Ingresar el email " >
                        </div>
                        ...
                        <input type="submit" value="Registrar Artista" name="enviar" class="btn btn-primary" id="enviar" data-toggle="modal" data-target="#alerta">
