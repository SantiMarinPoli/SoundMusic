...
---------------------ALBUM-----------------------------
INSERT INTO ALBUM (NOMBRE, NUMERO_CANCIONES, FECHA_FINALIZACION,
RUTA_IMAGEN, ID_CIUDAD, ID_ARTISTA)
VALUES ('MIS SABANAS',10,NULL,NULL,1,1);
INSERT INTO ALBUM (NOMBRE, NUMERO_CANCIONES, FECHA_FINALIZACION,
RUTA_IMAGEN, ID_CIUDAD, ID_ARTISTA)
VALUES ('MIS COBIJAS',10,NULL,NULL,2,1);
INSERT INTO ALBUM (NOMBRE, NUMERO_CANCIONES, FECHA_FINALIZACION,
RUTA_IMAGEN, ID_CIUDAD, ID_ARTISTA)
VALUES ('MIS ALMOHADAS',10,NULL,NULL,1,2);
INSERT INTO ALBUM (NOMBRE, NUMERO_CANCIONES, FECHA_FINALIZACION,
RUTA_IMAGEN, ID_CIUDAD, ID_ARTISTA)
VALUES ('MIS CHANCLAS',10,NULL,NULL,1,2);
INSERT INTO ALBUM (NOMBRE, NUMERO_CANCIONES, FECHA_FINALIZACION,
RUTA_IMAGEN, ID_CIUDAD, ID_ARTISTA)
VALUES ('MIS NOCHES',10,NULL,NULL,1,2);

---------------------ALBUM-----------------------------
INSERT INTO REGALIA(TOTAL_GANADO,NUMERO_OPERACIONES,FECHA,ID_ARTISTA_EMPRESA,ID_COSTO)
VALUES (75,15,TO_TIMESTAMP('2018-11-22 12:10:15', 'YYYY-MM-DD HH24:MI:SS.FF2'),1,1);
INSERT INTO REGALIA(TOTAL_GANADO,NUMERO_OPERACIONES,FECHA,ID_ARTISTA_EMPRESA,ID_COSTO)
VALUES (75,15,TO_TIMESTAMP('2018-11-22 12:10:15', 'YYYY-MM-DD HH24:MI:SS.FF2'),1,1);