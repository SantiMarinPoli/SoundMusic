                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    ...
                    <form action="controladorLogin" class="form-container" method="get">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="loginPassword" class="form-control" id="textPassword" placeholder="Ingredar la contraseña">
                        </div>

                        <input type="submit" value="Ingresar" class="btn btn-success btn-block" id="btnIngresar">
                    </form>
